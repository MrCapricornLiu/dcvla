...
Dynamic or task-relevant visual tokens remain in the prefill sequence and update the cache as usual. Reuse can be applied at a fixed subset of decoder layers (e.g., every $r$ layers), and the reuse ratio may be modulated by attention entropy; we find our method to be insensitive to the exact choice of $r$ within a reasonable range.
