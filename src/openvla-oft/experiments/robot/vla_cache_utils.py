...
def task_relevant_selection(multihead_attention, image, significant_patches, primary=True, top_k=100, delete_ratio=0.0, return_delete=False):
    """
    ...
    Positions are LLM visual-token positions: primary patches start at 1, wrist at 257.
    """
